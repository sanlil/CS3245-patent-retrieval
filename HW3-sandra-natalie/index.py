...
def indexing(training_path, postings_file, dictionary_file):
    """
    reads in training data and creates a posting and a dictionary file out of it
	...
	# sort alphabetically
    sort_word_list = sorted(word_list,key=lambda x: x[0])
    # sort numerically
...
def read_training_data(training_path):
    ...
    Returns:
		tuple of word and file list:
			...
			file_list	list of all file names (numbers)
                ...
                for sentence in sentences:
                    ...
                    for word in words:
                        ...
                        if word in string.punctuation: 
                            continue
                        # skip all words that contain at least one digit
...
def write_to_postings(f, current_word_freq, doc_lengths):
    ...
    for postingsFileNo in current_postings_keys:
        ...
        if current_word_freq[postingsFileNo] == 0:
            ...
            log_tf = 1 + math.log10(current_word_freq[postingsFileNo])
...
path_to_training = "/Users/sandra/nltk_data/corpora/reuters/training/"
...
indexing(path_to_training, postings_file, dictionary_file)
