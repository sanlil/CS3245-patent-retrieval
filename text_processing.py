...
#__stops |= {'mechanism', 'technology', 'technique', 'using', 'means', 'apparatus', 'method', 'system'}
...
def normalize(word):
    ...
    """
    if word in string.punctuation or (__debug_stop_words and word in __stops):
        return None
